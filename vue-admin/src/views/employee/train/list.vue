...
<template>
    <div class=''>
        <el-table :data="list" style="width: 100%;" border>
            ...
            <el-table-column prop="trainDate" label="培训日期" width="180" align="center"></el-table-column>
            <el-table-column prop="trainContent" label="培训内容" align="center"></el-table-column>
            <el-table-column prop="remark" label="备注" align="center" width="180"></el-table-column>
            <el-table-column label="操作" width="180" align="center">
                <template slot-scope="scope">
                    <router-link :to="'/employee/train/edit/' + scope.row.id">
...
export default {
    ...
    methods: {
        ...
        getList(page = 1) {
            this.current = page
            train.getListPage(this.current, this.size, this.serachObj)
                .then(res => {
