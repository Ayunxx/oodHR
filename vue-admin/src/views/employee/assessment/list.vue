...
<template>
    <div class=''>
        <el-table :data="list" style="width: 100%;" border>
            ...
            <el-table-column prop="appDate" label="考核时间" width="180" align="center"></el-table-column>
            <el-table-column prop="appContent" label="考核内容" align="center"></el-table-column>
            <el-table-column prop="appResult" label="考核结果" align="center" width="100"></el-table-column>
            <el-table-column prop="remark" label="备注" align="center" width="180"></el-table-column>
            <el-table-column label="操作" width="180" align="center">
                <template slot-scope="scope">
                    <router-link :to="'/employee/assessment/edit/' + scope.row.id">
    ...
    methods: {
        deleteById(id) {
            this.$confirm('此操作将永久删除数据, 是否继续?', '提示', {
                ...
                //调用删除接口
                assessment.deleteAssessmentById(id)
                    .then(res => {
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
        ...
        getList(page = 1) {
            this.current = page
            assessment.getListPage(this.current,this.size,this.serachObj)
                .then(res => {
